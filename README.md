...
[![HTML](https://img.shields.io/badge/Built%20with-Table--based%20HTML-orange)](#)
...
- 🌗 **Dark-mode-safe palette** — no invisible text, no disappearing icons
- 📱 **Mobile-hardened** — `white-space: nowrap` stops ugly line breaks on iPhone/Android
- 🏢 **Outlook-hardened** — `mso-line-height-rule`, `bgcolor` tables, bicubic image scaling
- 📊 **UTM-tagged links** — measure which link actually drives clicks & leads
- ♿ **Accessible** — `role="presentation"` tables + descriptive `alt` text
- 🚫 **Zero branding, zero tracking, zero external CSS/JS**

---

## 📬 Compatibility Matrix (Real-Device Tested)

| Email Client | Light Mode | Dark Mode | Mobile |
|---|:---:|:---:|:---:|
| Gmail (Web) | ✅ | ✅ | ✅ |
...
- **`mso-line-height-rule: exactly`** — kills Outlook's random vertical spacing
- **`-ms-interpolation-mode: bicubic`** — crisp (non-pixelated) images in Windows clients
...
**Gmail:** Settings ⚙️ → *See all settings* → **Signature** → Create new → click the `<>` (HTML) icon → paste code → **OK** → Save Changes.
...
> 💡 **Pro tip:** Always send yourself a test email and check it on **desktop + phone + dark mode** before going live.
...
**Mohammad Tanvir** — Python Web Scraping Expert · AI Agents & Automation Consultant.
I help businesses scale with flawless data, lead generation and custom AI automations.
24,000+ LinkedIn network · proven Upwork track record.

[LinkedIn](https://www.linkedin.com/in/seotanvirbd/) · [GitHub](https://github.com/seotanvirbd) · [Medium](https://medium.com/@seotanvirbd) · [YouTube](https://www.youtube.com/@tanvirbinali2200) · [Gumroad Products](https://mohammadtanvir.gumroad.com/)

---

## ⭐ Found this useful?

Give the repo a **star** ⭐ and share it with someone whose email signature needs a rescue.

## 📄 License

MIT — free for personal & commercial use. Attribution appreciated, never required.
